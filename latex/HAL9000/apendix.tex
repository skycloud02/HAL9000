...
In \projectnamez the UsermodeLibrary library defines the entry point of every application:
...
Use only one of them. We recommend using \file{HAL9000\_checkout.pl}. The difference between them 
is that \file{HAL9000\_checkout.pl} pulls the latest source files from the HAL9000 repository, while
